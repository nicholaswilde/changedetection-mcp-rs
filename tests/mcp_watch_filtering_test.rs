...
async fn test_mcp_list_watches_filter_paused() {
    ...
    app.mock_get("/api/v1/watch", 200, Some(list_response)).await;
    ...
    app.mock_get("/api/v1/watch/uuid-1", 200, Some(details_1)).await;
    app.mock_get("/api/v1/watch/uuid-2", 200, Some(details_2)).await;
...
async fn test_mcp_list_watches_filter_unpaused() {
    ...
    app.mock_get("/api/v1/watch/uuid-1", 200, Some(json!({"url": "https://example.com/1", "paused": true}))).await;
    app.mock_get("/api/v1/watch/uuid-2", 200, Some(json!({"url": "https://example.com/2", "paused": false}))).await;
...
async fn test_mcp_list_watches_filter_error() {
    ...
    app.mock_get("/api/v1/watch/uuid-1", 200, Some(json!({"url": "https://example.com/1", "last_error": "Some error"}))).await;
    app.mock_get("/api/v1/watch/uuid-2", 200, Some(json!({"url": "https://example.com/2", "last_error": false}))).await;
